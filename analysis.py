...
def main():
    ...
    revenue_distribution(conn, "revenue_distribution_03", revenue_scale="linear", max_revenue=1000000, tag_whitelist=[1670, 492], tag_blacklist=[1741])
    revenue_distribution(conn, "revenue_distribution_03_log", revenue_scale="log", tag_whitelist=[1670, 492], tag_blacklist=[1741])
    revenue_distribution(conn, "revenue_distribution_04_log", revenue_scale="log", tag_whitelist=[1091588])
    revenue_distribution(conn, "revenue_distribution_05_log", revenue_scale="log", tag_whitelist=[5432])
...
def revenue_distribution(conn, filename, max_revenue=None, revenue_scale="linear", tag_whitelist=None, tag_blacklist=None):
    query = f"""
